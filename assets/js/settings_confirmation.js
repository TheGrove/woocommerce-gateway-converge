...
jQuery(function ($) {
	const enable_save_payment_methods = $(
	...
	enable_subscriptions.change(function () {
		enable_subscriptions_checkbox_functionality(
			$(this),
			enable_save_payment_methods
		);
	});
...
function enable_subscriptions_checkbox_functionality(
	enable_subscriptions_checkbox,
	enable_save_payment_methods_checkbox
) {
