...
<form id="order_review" method="post">
	...
	<div class="form-row">
		<input type="submit" id="place_order" class="button alt" value="<?php esc_html_e('Change Payment Method', 'elavon-converge-gateway' )?>" data-value="<?php  esc_html_e('Change Payment Method', 'elavon-converge-gateway' )?>">
	</div>
	<?php else:
